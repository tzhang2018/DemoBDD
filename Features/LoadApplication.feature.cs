...
namespace DemoBDD.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("LoadApplication")]
    public partial class LoadApplicationFeature
    {
...
#line 1 "LoadApplication.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "LoadApplication", "As a loan application evaluator\r\nI want to only approve loan requests that meet o" +
                    "ur agreed upon load amount rules\r\nSo the risk associated with supplying loans re" +
                    "mains within regulatory boundaries", ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
        ...
        public void ForLoanAmountsBetween1000And100000TheResultDepnesOnIncome(string amount, string income, string result, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("For loan amounts between 1000 and 100000 the result depnes on income", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 26
this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
